class SurvivalGuide {
  ...
  static List<SurvivalGuide> getSampleGuides() {
    return [
      ...
      SurvivalGuide(
        id: '5',
        title: 'ระวังและหลีกเลี่ยงในการเดินทาง',
        description: 'เพื่อความปลอดภัยในการเดินทางช่วงน้ำท่วม',
        iconPath: 'assets/icons/survival.png',
        category: 'ระหว่างน้ำท่วม',
        importance: 5,
        steps: [
          SurvivalStep(
            ...
            description:
                'หลีกเลี่ยงการเดินฝ่ากระแสน้ำ โดยเฉพาะในน้ำที่ไหลเชี่ยวซึ่งอาจทำให้ถูกพัดพาไปได้ คอยสังเกตสภาพน้ำ หากน้ำมีความลึกหรือไหลแรง ควรหาทางเลือกอื่นเพื่อหลีกเลี่ยงหากจำเป็นต้องข้ามน้ำ ให้ใช้เส้นทางที่มั่นคงและพยายามยึดสิ่งที่มั่นคงเพื่อไม่ให้ลื่นหรือถูกพัดพา',
            imageUrl: 'assets/images/water_flow.png',
          ),
          SurvivalStep(
            title: 'ระวังน้ำลึกที่มีความเสี่ยง',
            description:
                'ตรวจสอบระดับน้ำก่อนข้ามหรือเดินผ่าน เพราะน้ำลึกอาจทำให้เกิดอันตราย หากน้ำสูงถึงเอวหรือสูงกว่านั้น ไม่ควรเดินฝ่าน้ำ เพราะอาจทำให้เสียการทรงตัวหากคุณไม่สามารถหลีกเลี่ยงการเดินผ่านน้ำได้ ให้เดินอย่างระมัดระวัง และหาทางออกที่ปลอดภัย',
      ...
      SurvivalGuide(
        id: '6',
        title: '!! ห้ามทำระหว่างน้ำท่วม !!',
        description: 'หลีกเลี่ยงพฤติกรรมเสี่ยงเพื่อความปลอดภัยระหว่างน้ำท่วม',
        iconPath: 'assets/icons/survival.png',
        category: 'ระหว่างน้ำท่วม',
        importance: 4,
        steps: [
          SurvivalStep(
            title: 'ห้ามทิ้งขยะลงน้ำ',
            description: '''ขยะทำให้น้ำท่วมหนักขึ้น!
    "อุดตันทางระบายน้ำ ทำให้น้ำไหลไม่สะดวก"
    "สร้างมลพิษทางน้ำ ส่งผลเสียต่อสัตว์น้ำและสิ่งแวดล้อม"
    "ทำให้เกิดกลิ่นเหม็นและแหล่งเพาะเชื้อโรค"
    "คำแนะนำ: ทิ้งขยะในที่ที่เหมาะสมและช่วยกันรักษาความสะอาด" ''',
            imageUrl: 'assets/images/dont1.jpg',
          ),
          SurvivalStep(
            title: 'ห้ามเดินลุยน้ำ',
            description: '''น้ำท่วมอาจซ่อนอันตรายไว้มากมาย!
    "เสี่ยงติดเชื้อโรคร้ายแรง เช่น ฉี่หนู อหิวาตกโรค และแบคทีเรียที่ทำให้ท้องร่วง"
    "อาจมีเศษแก้ว ตะปู หรือสิ่งของแหลมคม ที่มองไม่เห็น อาจทำให้บาดเจ็บรุนแรง"
    "กระแสไฟฟ้ารั่วไหลจากสายไฟขาด เสี่ยงต่อการถูกไฟดูดเสียชีวิต"
    "คำแนะนำ: หลีกเลี่ยงการเดินลุยน้ำ หากจำเป็นให้สวมรองเท้าบูทยางป้องกัน" ''',
            imageUrl: 'assets/images/dont2.jpg',
          ),
          SurvivalStep(
            title: 'ห้ามใช้ไฟฟ้า',
            description: '''อุปกรณ์ไฟฟ้าอาจเป็นอันตรายถึงชีวิต!
    "น้ำอาจทำให้วงจรไฟฟ้าช็อต เสี่ยงต่อการเกิดไฟไหม้"
    "ไฟฟ้ารั่วในบริเวณที่เปียกชื้น อาจทำให้เกิดอุบัติเหตุไฟดูด"
    "ควรถอดปลั๊กอุปกรณ์ไฟฟ้าทั้งหมด หากน้ำเริ่มเข้าบ้าน"
    "คำแนะนำ: ปิดสวิตช์ไฟหลักและหลีกเลี่ยงการใช้ไฟฟ้าขณะน้ำท่วม" ''',
            imageUrl: 'assets/images/dont3.jpg',
          ),
          SurvivalStep(
            title: 'ห้ามดื่มน้ำท่วม',
            description: '''น้ำท่วมไม่ใช่น้ำสะอาด!
    "ปนเปื้อนเชื้อโรค เช่น อหิวาตกโรค ไวรัสตับอักเสบ A และแบคทีเรียอื่นๆ"
    "อาจมีสารเคมีอันตราย เช่น น้ำมัน สารเคมีจากโรงงาน"
    "ขยะและของเสียจากท่อระบายน้ำ อาจเป็นอันตรายต่อสุขภาพ"
    "คำแนะนำ: ดื่มเฉพาะน้ำที่สะอาดและผ่านการกรองหรือต้มแล้วเท่านั้น" ''',
            imageUrl: 'assets/images/dont4.jpg',
          ),
          SurvivalStep(
            title: 'ห้ามออกจากบ้านโดยไม่จำเป็น',
            description: '''อยู่บ้านปลอดภัยกว่า!
          "ถนนลื่นและน้ำเชี่ยวอาจพัดพาตัวคุณไปได้"
          "ไฟฟ้ารั่วจากสายไฟขาดเป็นอันตรายร้ายแรง"
          "ความช่วยเหลืออาจล่าช้าในพื้นที่น้ำท่วมหนัก"
          "คำแนะนำ: หากไม่มีเหตุจำเป็น ให้อยู่ในที่ปลอดภัยและติดตามข่าวสาร" ''',
            imageUrl: 'assets/images/dont5.jpg',
          ),
        ],
      ),
      ...
      SurvivalGuide(
        ...
        steps: [
          SurvivalStep(
            ...
            description:
                'ตรวจสอบระดับน้ำในพื้นที่ที่อยู่ใกล้เคียง และติดตามทิศทางการไหลของน้ำเพื่อเตรียมความพร้อมในการเคลื่อนย้ายหรือหลีกเลี่ยงพื้นที่ที่มีความเสี่ยง',
            imageUrl: 'assets/images/water_levels.png',
          ),
          SurvivalStep(
            title: 'ฟังประกาศจากทางการหรือหน่วยงานช่วยเหลือ',
            description:
                'ฟังการประกาศหรือคำแนะนำจากทางการหรือหน่วยงานช่วยเหลือ เช่น การอพยพหรือการแจ้งเตือนสถานการณ์ เพื่อปฏิบัติตามอย่างถูกต้อง',
          ...
          SurvivalStep(
            ...
            description:
                'หลีกเลี่ยงการเดินทางหรือเคลื่อนย้ายในเวลากลางคืนหรือในพื้นที่ที่มีน้ำไหลแรง เพื่อความปลอดภัยจากอุบัติเหตุหรืออันตราย',
      ...
      SurvivalGuide(
        ...
        steps: [
          SurvivalStep(
            ...
            description:
                'จัดเตรียมน้ำดื่มสะอาดและอาหารแห้ง เก็บไว้ในที่ที่สามารถเข้าถึงได้ง่าย',
            imageUrl: 'assets/images/food_water.png',
          ),
          SurvivalStep(
            title: 'โทรศัพท์มือถือพร้อมแบตสำรอง',
            description:
                'เตรียมโทรศัพท์มือถือและแบตสำรอง เพื่อให้สามารถติดต่อสื่อสารได้ในกรณีเกิดเหตุการณ์ฉุกเฉิน',
            imageUrl: 'assets/images/powerbank.png',
          ),
          SurvivalStep(
            title: 'ยาประจำตัว',
            description:
                'จัดเตรียมยาประจำตัวหรือยาที่จำเป็นต่อการรักษาสุขภาพ เช่น ยาลดไข้ ยาลดความดัน หรือยาสำหรับโรคประจำตัว',
            imageUrl: 'assets/images/drug.png',
          ),
          SurvivalStep(
            title: 'เอกสารสำคัญ (ใส่ถุงกันน้ำ)',
            description:
                'รวบรวมเอกสารสำคัญ เช่น บัตรประชาชน ทะเบียนบ้าน และเอกสารทางการเงิน แล้วใส่ในถุงกันน้ำเพื่อป้องกันความเสียหายจากน้ำท่วม',
